...
const Hero = () => {
    ...
    return (
        <section id="hero">
            ...
            <div className="container d-flex direction-sm-col direction-md-row position-relative justify-space-between p-x-40 p-y-100 padding-sm-20">
                <div className="container__col-sm-12 container__col-lg-6">
                    ...
                    <div className="d-flex justify-sm-center p-y-30">
