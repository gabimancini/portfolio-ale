...
const About = () => {
    return (
        <section id="about">
            <div className="container d-flex justify-space-between direction-sm-col direction-md-row p-y-100 p-x-20 padding-sm-20">
                <div className="container__col-lg-7 container__col-md-8">
                    <h2 className="color-primary-black font-size-h2 text-md-center m-y-10">About ME</h2>
                ...
                <div className="container__col-sm-12 container__col-md-4 m-md-auto m-sm-20">
