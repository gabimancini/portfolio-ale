...
const About = () => {
    return (
        <section id="about">
            <div className="container d-flex justify-space-between wrap p-y-100 p-x-20 padding-md-20">
                ...
                <div className="container__col-sm-12 container__col-md-3 m-md-auto m-md-20">
